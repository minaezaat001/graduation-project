 ...
 <head>
     ...
     <title>ألابحاث و التكاليف </title>
     <!-- Links -->
     ...
     <header>
         ...
         <div class="primary-nav">
             <div class="head d-flex justify-content-between">
                 ...
                 <img src="{{ URL::asset('student/images/header/logo2.jpg') }}" width="40px" height="40px"
                     alt="logo" />
             </div>
         ...
         <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
             <div class="carousel-inner">
                 <div class="carousel-item active">
                     <img class="d-block w-100" src="{{ URL::asset('student/images/slider/slider.jpg') }}"
                         alt="First slide" />
                 </div>
                 <div class="carousel-item">
                     <img class="d-block w-100" src="{{ URL::asset('student/images/slider/slider2.jpg') }}"
                         alt="Second slide" />
                 </div>
                 <div class="carousel-item">
                     <img class="d-block w-100" src="{{ URL::asset('student/images/slider/slider3.jpg') }}"
                         alt="Third slide" />
                 </div>
             </div>
