...
<body>
            ...
            <div class="row">
                <div class="col-4">
                    ...
                    <div class="mulit">
                        ...
                        <input class="border w-100 border mt-3 p-2 inp_answer_a" type="text"
                            placeholder="الاجابة الصحيحة" />
                        <input class="border w-100 border mt-3 p-2 inp_answer_b" type="text"
                            placeholder="الاجابة الخاطئة" />
                        <input class="border w-100 border mt-3 p-2 inp_answer_c" type="text"
                            placeholder="الاجابة الخاطئة" />
                        <input class="border w-100 border mt-3 p-2 inp_answer_d" type="text"
                            placeholder="الاجابة الخاطئة" />
                    </div>
                    <div class="true_area off">
                        <input class="border w-100 border mt-3 p-2 inp_title_tf" type="text"
                            placeholder="عنوان السوال" />
                        <input class="border w-100 border mt-3 p-2 inp_answer_a_tf" type="text"
                            placeholder="الاجابة الصحيحة" />
                        <input class="border w-100 border mt-3 p-2 inp_answer_b_tf" type="text"
                            placeholder="الاجابة الخاطئة" />
                    </div>
    ...
    <!-- copy Right -->
    <div class="copy text-center pt-3 mt-4">
