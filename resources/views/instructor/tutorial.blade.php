...
<body>
            ...
            <div class="row">
                <div class="col-md-4" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="1500">
                    <div class="desc">
                        <h2>zoom</h2>
                        <p>
                            نص تجربي يمكن استبداله نص تجربي يمكن
                            استبداله نص تجربي يمكن استبداله نص تجربي
                            يمكن استبداله نص تجربي يمكن استبداله
                        </p>
                        <a href="{{ URL::asset('totu/Zoom For Instructor.pdf') }}">حمل من هنا</a>
                    </div>
                </div>
                <div class="col-md-8" data-aos="fade-right" data-aos-easing="ease-out-cubic" data-aos-duration="1500">
                    <video playsinline="playsinline" width="100%" autoplay="autoplay" muted="muted" loop="loop">
                        <source src="{{ URL::asset('totu/Zoom For Instructor.mp4') }}" type="video/mp4" />
                    </video>
                </div>
            </div>
        </div>
    ...
    <section class="py-5" id="teams">
        <div class="container">
            <div class="row">
                <div class="col-md-8" data-aos="fade-left" data-aos-easing="ease-out-cubic" data-aos-duration="1500">
                    <video playsinline="playsinline" width="100%" autoplay="autoplay" muted="muted" loop="loop">
                        <source src="{{ URL::asset('totu/Teams for instructors.wmv') }}" type="video/mp4" />
                    </video>
                </div>
                <div class="col-md-4" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="1500">
                    <div class="desc">
                        ...
                        <a href="{{ URL::asset('totu/TeamsForStudents.pdf') }}">حمل من هنا</a>
                    </div>
                </div>
            </div>
        </div>
