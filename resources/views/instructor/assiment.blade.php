        ...
        <section id="lectures" class="test block">
            <div class="container">
                ...
                <button type="button" class="border border mt-3 py-2 px-3 btn addBtnStyle" data-toggle="modal"
                    data-target="#exampleModalCenter">أضافة تكليف جديدة</button>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <input class="border w-100 border my-3 p-2" type="text" placeholder="اسم التكليف" />
